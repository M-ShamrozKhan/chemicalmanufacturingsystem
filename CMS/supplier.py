...
class supplierClass:
    def __init__(self, root):
        ...
        #===row1======
        lbl_supplier_invoice=Label(self.root,text="Invoice No.",font=("goudy old style",15,"bold"),bg="white").place(x=40,y=80)              
        ...
        #======row2======
        lbl_name=Label(self.root,text="Supplier Name",font=("goudy old style",15,"bold"),bg="white").place(x=40,y=120)              
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="lightyellow").place(x=180,y=120,width=180)              
         
        #====row3===
        lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15,"bold"),bg="white").place(x=40,y=160)              
        ...
        #====row4===
        lbl_desc=Label(self.root,text="Description",font=("goudy old style",15,"bold"),bg="white").place(x=40,y=200)              
    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error", "Invoice n.o already assigned, try different",parent=self.root)
                else:
