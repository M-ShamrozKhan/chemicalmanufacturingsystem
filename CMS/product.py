...
#===========LABEL===================
  ...
  #========OPTION COMBOBOX=================      
        ...
        cmb_status=ttk.Combobox(product_Frame,textvariable=self.var_status,values=("Active","Inactice"),state="readonly",justify=CENTER,font=("goudy old style",15))
...
#============update=================
    ...
    def update(self):
        ...
        try:
            if self.var_pid.get()=="":
                messagebox.showerror("Error","Please slect product from list",parent=self.root)
            else:
